...
Ready to contribute? Here's how to set up `djangocms-forms` for local development.

1. Fork the `djangocms-forms` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/djangocms-forms.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv djangocms-forms
    $ cd djangocms-forms/
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_djangocms_forms